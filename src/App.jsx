    ...
    <>
     ...
     <div className='w-10/12 mx-auto'>
      ...
      <div>
       ...
       <button onClick={() =>setToggle(false)} className= {`p-3 border-1 border-gray-400 rounded-r-2xl ${toggle === false?"bg-amber-300" : ""} `}>Selected <span>(0)</span></button>
      </div>
     </div>
{
  toggle === true?  <Suspense fallback={<h2>.......players are loading</h2>} >
       <Players setAvailableBalance={setAvailableBalance}  playersPromiseData={playersPromiseData} ></Players>
